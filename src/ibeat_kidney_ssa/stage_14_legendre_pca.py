...
import miblab_ssa.sdf_legendre as model
...
def run(build, client):
    ...
    logging.info("Stage 14.3 Computing PCA scores")
    ssa.scores_from_features(features, pca, scores)

    logging.info("Stage 14.4 Computing PCA performance")
    ssa.pca_performance(
        pca, scores, 
        features, 
        marginal_mse, 
    ...
    logging.info("Stage 14.5 Computing reconstruction accuracy")
