...
def run(build, client):
    ...
    logging.info("Stage 14 --- Legendre PCA ---")
    ...
    logging.info("Stage 14.6 Display principal modes")
    pipe.adjust_workers(client, 16)
    display.modes(mask_modes_path, dir_png, movie_file)

    logging.info("Stage 14.7 Display reconstruction accuracy")
    ...
    logging.info("Stage 14: Legendre PCA successfully completed.")
