...
def run(build, client):
    ...
    logging.info("Stage 12.8 Displaying reconstruction")
    display.recon(mask_recon, recon_png, recon_mp4)

    logging.info("Stage 12.9 Displaying reconstruction error")
    display.recon_err(mask_recon_err, recon_err_png, recon_err_mp4)

    logging.info("Stage 12.10 Displaying principal modes")
